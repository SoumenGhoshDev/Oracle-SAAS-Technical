...
Due to some urgent work , Manager can request their subordinates to work even if they are on Parental Leave. As a beenfit for the same Manager can reward Kit Days in return. There are below restrictions on the same.
...
1. One Input Validation Fast Formula
2. Three Value Sets to get below information
